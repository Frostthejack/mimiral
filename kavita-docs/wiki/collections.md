# Collections
URL: https://wiki.kavitareader.com/guides/features/collections/
...
## Smart Collections (Kavita+)
Smart Collections are collections that are created from MAL (Interest stacks). These collections are managed by Kavita for you and will sync them with their upstream provider every few days. This feature is for Kavita+ subscribers only.
